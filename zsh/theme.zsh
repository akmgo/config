...
### Segment drawing
# A few utility functions to make it easy and reusable to draw segmented prompts
...
prompt_context() {
  prompt_segment "$AGNOSTER_CONTEXT_BG" "$AGNOSTER_CONTEXT_FG" "%F{blue}Akram"
}
